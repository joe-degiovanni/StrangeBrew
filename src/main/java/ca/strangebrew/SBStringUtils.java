...
public class SBStringUtils {
	...
	public static String getAppPath(String type) throws UnsupportedEncodingException{
		...
		ca.strangebrew.Debug.print("Path: " + appRoot);
		
		
		if (type.equals("data"))
			path = appRoot + slash + "classes" + slash + "data";
		else if (type.equals("icons"))
			path = appRoot + slash + "classes" + slash + "icons";
		else if (type.equals("recipes"))
			path = appRoot + slash + "classes" + slash + "recipes";
		else if (type.equals("help"))
			path = "file://" + appRoot + "classes" + slash + "help" + slash;
		else if (type.equals("ini"))
			path = appRoot + slash + "classes" + slash;
		else if (type.toLowerCase().contains("splash"))
			path = appRoot + slash  + "classes" + slash + type;
		else
			path = appRoot;
