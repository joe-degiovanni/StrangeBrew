...
public class StrangeSwing extends javax.swing.JFrame implements ActionListener, FocusListener, WindowListener,
	...
	private static final Logger logger = Logger.getLogger(StrangeSwing.class.getName());
...
//		waterTreatmentPanel.setData(myRecipe);
	...
	private void initGUI() {
		try {
			...
			imgURL = getClass().getClassLoader().getResource("icons/sb2.gif");
...
//						jTabbedPane1.addTab("Water Treatment", null, waterTreatmentPanel, null);
			...
			}
			{
				setJMenuBar(mainMenuBar);
				{
					...
					{
						imgURL = getClass().getClassLoader().getResource("icons/find.gif");
						icon = new ImageIcon(imgURL);
					...
					{
						imgURL = getClass().getClassLoader().getResource("icons/save.gif");
						icon = new ImageIcon(imgURL);
					...
					{
						imgURL = getClass().getClassLoader().getResource("icons/saveas.gif");
						icon = new ImageIcon(imgURL);
					...
					}
					{
						...
						imgURL = getClass().getClassLoader().getResource("icons/print.gif");
						icon = new ImageIcon(imgURL);
